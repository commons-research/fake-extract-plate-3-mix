...
```bash
sg commons-users -c './copy_files.sh -i /media/share/mapp/public/QE_HFX_unifr/converted -o /msdata/mapp_project_00001/mapp_batch_00001 -p "*mapp_01_*.mzML"'
```

### Transfer the metadata to the msdata folder

```bash
cd ./docs/mapp_project_00001/mapp_batch_00001/
cp ./metadata/treated/mapp_batch_00001_metadata.tsv /msdata/mapp_project_00001/mapp_batch_00001/
```
...
```bash
cd ./docs/mapp_project_00001/mapp_batch_00001/results/mzmine
```

And proceed to awk black magic to update the mzmine xml file

```bash
awk -v dir="/msdata/mapp_project_00001/mapp_batch_00001" '
BEGIN {
  cmd = "ls " dir "/*.mzML"
...
}' mapp_batch_00001.mzbatch_template > mapp_batch_00001.mzbatch
```
...
```bash
sg commons-users -c '/opt/mzmine/bin/mzmine -batch mapp_batch_00001.mzbatch'
```
...
```bash
taxonomical-utils resolve-taxa --input-file docs/mapp_project_00001/mapp_batch_00001/metadata/original/mapp_batch_00001_metadata.tsv --output-file docs/mapp_project_00001/mapp_batch_00001/metadata/original/mapp_batch_00001_metadata_resolved.csv --org-column-header source_taxon
```

2. retrieve upper taxa lineage
    
```bash
taxonomical-utils append-taxonomy --input-file docs/mapp_project_00001/mapp_batch_00001/metadata/original/mapp_batch_00001_metadata_resolved.csv --output-file docs/mapp_project_00001/mapp_batch_00001/metadata/original/metadata_upper_taxa_lineage.csv
```

3. append WD ids 

```bash
taxonomical-utils append-wd-id --input-file docs/mapp_project_00001/mapp_batch_00001/metadata/original/mapp_batch_00001_metadata_resolved.csv --output-file docs/mapp_project_00001/mapp_batch_00001/metadata/original/mapp_batch_00001_wd.csv
```

```bash
taxonomical-utils merge --input-file docs/mapp_project_00001/mapp_batch_00001/metadata/original/mapp_batch_00001_metadata.tsv --resolved-taxa-file docs/mapp_project_00001/mapp_batch_00001/metadata/original/mapp_batch_00001_metadata_resolved.csv --upper-taxa-lineage-file docs/mapp_project_00001/mapp_batch_00001/metadata/original/metadata_upper_taxa_lineage.csv --wd-file docs/mapp_project_00001/mapp_batch_00001/metadata/original/mapp_batch_00001_wd.csv --output-file docs/mapp_project_00001/mapp_batch_00001/metadata/treated/mapp_batch_00001_metadata.tsv --org-column-header source_taxon
```
...
ssh commons-server
tmux a -t sirius
cd ~/git_repos/mapp-metabolomics-unit/fake-extract-plate-3-mix/docs/mapp_project_00001/mapp_batch_00001/results
```
...
paths:
  ...
  input_folder: /Users/visanim/work/random-markov-field/fake-extract-plate-3-mix/docs/mapp_project_00001/mapp_batch_00001/results/met_annot_enhancer # The path were you want your GNPS job folder to be placed
  project_name: mapp_batch_00001 #ISDB_annot_LP_plantfungi_set # The name you want to give to your project, output resulst in data_out/project_name
  output_folder: /Users/visanim/work/random-markov-field/fake-extract-plate-3-mix/docs/mapp_project_00001/mapp_batch_00001/results/met_annot_enhancer # the path for your output to be stored in
...
```
```bash
python /Users/visanim/work/random-markov-field/mandelbrot_project/met_annot_enhancer/src/dev/nb.py
```
...
```yaml
paths:
  docs: '/Users/visanim/work/random-markov-field/fake-extract-plate-3-mix/docs'
  output: '/Users/visanim/work/random-markov-field/fake-extract-plate-3-mix/docs/mapp_project_00001/mapp_batch_00001/results/stats' # Not mandatory, default is in the stats subdirectory
...
```yaml
mapp_project : mapp_project_00001
mapp_batch : mapp_batch_00001
met_annot_enhancer_folder : mapp_batch_00001
gnps_job_id : 

dataset_experiment : 
  name: "mapp_batch_00001 LCMS metabolomics dataset"
  description: "Untargeted matabolomics of fake-extract-plate-3 positive mode"
...
``````bash
Rscript /Users/visanim/work/random-markov-field/biostat_toolbox/src/biostat_toolbox.r
```
...
```bash
met-annot-unifier-cli align-horizontally --canopus-file ./results/sirius/canopus_structure_summary.tsv --gnps-file ./results/met_annot_enhancer//nf_output/library/merged_results_with_gnps.tsv --gnps-mn-file ./results/met_annot_enhancer//nf_output/networking/clustersummary_with_network.tsv --sirius-file ./results/sirius/structure_identifications.tsv --isdb-file ./results/met_annot_enhancer/mapp_batch_00001/mapp_batch_00001_spectral_match_results_repond_flat.tsv --output ./results/tmp/mapp_batch_00001_met_annot_unified_horizontal.tsv
```

#### Align vertically

```bash
met-annot-unifier-cli align-vertically  --gnps-file ./results/met_annot_enhancer//nf_output/library/merged_results_with_gnps.tsv --isdb-file ./results/met_annot_enhancer/mapp_batch_00001/mapp_batch_00001_spectral_match_results_repond_flat.tsv --sirius-file ./results/sirius/structure_identifications.tsv  --output ./results/tmp/mapp_batch_00001_met_annot_unified_vertical.tsv
```